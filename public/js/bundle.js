    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          if (res.data.status == 'success') {
            (0, _alert.showAlert)('success', 'You are logged Out');
            window.setTimeout(function () {
              location.assign('/');
            }, 1000);
          }
...
var displaymap = exports.displaymap = function displaymap(locatio) {
  maptilersdk.config.apiKey = '4U0UobBOROFgioLUnPP8';
  var map = new maptilersdk.Map({
    container: 'map',
    // container's id or the HTML element to render the map
    style: "backdrop",
    center: locatio[0].coordinates,
    // starting position [lng, lat]
    zoom: 4,
    // starting zoom
    scrollZoom: false
  });
  locatio.forEach(function (loc) {
    //add marker
    ...
    new maptilersdk.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).setPopup(new maptilersdk.Popup().setHTML("<p> Day".concat(loc.day, " : ").concat(loc.description, "</p>"))).addTo(map);
  });
};
},{}],"../../utils/apperror.js":[function(require,module,exports) {
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status == 'success') {
            (0, _alert.showAlert)('success', 'Data is successfuly updated');
          }
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee2(passwordCur, password, passwordConfirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 3:
          ...
          if (res.data.status == 'success') {
            (0, _alert.showAlert)('success', 'password is successfuly changed');
          }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","../../utils/apperror":"../../utils/apperror.js"}],"signup.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status == 'success') {
            (0, _alert.showAlert)('success', 'Account is Created');
            window.setTimeout(function () {
              location.assign('/');
            }, 1000);
          }
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee(tourId, response) {
    var session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', 'error acurs while booking tour');
...
var update_name_emailBtn = document.querySelector('.form-user-data');
var passwordchangeBtn = document.querySelector('.form-user-settings');
...
if (maptiler) {
  var locatio = JSON.parse(maptiler.dataset.locations);
  (0, _mapbox.displaymap)(locatio);
}
...
if (update_name_emailBtn) {
  var button2 = document.querySelector('.iadd2');
  button2.addEventListener('click', function (e) {
    e.preventDefault(); // form datatype is necessary for photo encryption

    var form = new FormData();
    form.append('name', document.getElementById('name').value);
    form.append('email', document.getElementById('email').value);
    form.append('photo', document.getElementById('photo').files[0]);
    (0, _update.updateme)(form);
  });
}
...
if (passwordchangeBtn) {
  var button = document.querySelector('.iadd');
  ...
  function () {
    ...
    _regeneratorRuntime().mark(function _callee(e) {
      var curpassword, passwordnew, passwordnewconf;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            button.textContent = 'Updating Password...';
            curpassword = document.getElementById('password-current').value;
            passwordnew = document.getElementById('password').value;
            passwordnewconf = document.getElementById('password-confirm').value;
            _context.next = 7;
            return (0, _update.updatepassword)(curpassword, passwordnew, passwordnewconf);
...
if (signUPBtn) {
  signUPBtn.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email').value;
    var role = document.getElementById('Role').value; // const photo = document.getElementById('Photo').value;  i will add it later
